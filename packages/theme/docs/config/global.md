...
下面开始详细介绍 [Theme.BlogConfig](https://github.com/zhouxun0803/blob/255c4b1e6a85a529be3a72c88e365077e067ecba/packages/theme/src/composables/config/index.ts#L69-L137)
...
详细配置和使用方法可以见插件文档：[vitepress-plugin-pagefind](https://github.com/zhouxun0803/blob/master/packages/vitepress-plugin-pagefind/README-zh.md)
...
::: tip 已拆分为独立插件
详细配置和使用方法可以见插件文档：[vitepress-plugin-announcement](https://github.com/zhouxun0803/blob/master/packages/vitepress-plugin-announcement/README.md)
:::
...
用于设置图片预览插件的配置项，详见[插件文档](https://github.com/zhouxun0803/blob/master/packages/vitepress-plugin-image-preview/README.md)

::: tip 已拆分为独立插件
详细配置和使用方法可以见插件文档：[vitepress-plugin-image-preview](https://github.com/zhouxun0803/blob/master/packages/vitepress-plugin-image-preview/README.md)
:::
...
const RSS: Theme.RSSOptions = {
  title: '@sugarat/theme',
  baseUrl,
  copyright: 'Copyright (c) 2023-present, 勋染',
}
