...
export default defineConfig({
  ...
  lang: 'zh-cn',
  title: '@sugarat/theme',
  description: '勋染的博客主题，基于 vitepress 实现',
  rewrites: {
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/zhouxun0803/tree/master/packages/theme'
      },
      {
        icon: 'x',
    ...
    editLink: {
      pattern:
        'https://github.com/zhouxun0803/tree/master/packages/theme/docs/:path',
      text: '去 GitHub 上编辑内容'
    },
