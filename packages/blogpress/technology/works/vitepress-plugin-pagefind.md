...
① 安装 [vitepress-plugin-pagefind](https://github.com/zhouxun0803/tree/master/packages/vitepress-plugin-pagefind)
```sh
...
这部分主要介绍 `vitepress-plugin-pagefind` 的关键实现部分（细节可看[源码](https://github.com/zhouxun0803/tree/master/packages/vitepress-plugin-pagefind)，如读者有更好的实现思路可以评论区交流）
